...
### [043](043.py)
Desenvolva uma lógica que leia o peso e a altura de uma pessoa, calcule seu Índice de Massa Corporal (IMC) e mostre seu status, de acordo com a tabela abaixo: Abaixo de 18.5: Abaixo do Peso; Entre 18.5 e 25: Peso Ideal; 25 até 30: Sobrepeso; 30 até 40: Obesidade; Acima de 40: Obesidade Mórbida.
...
### [066](066.py)
Crie um programa que leia vários números inteiros pelo teclado. O programa só vai parar quando o usuário digitar o valor 999. No final, mostre quantos números foram digitados e qual foi a soma entre eles (desconsiderando o flag).
...
### [070](070.py)
Crie um programa que leia o nome e o preço de vários produtos. O programa deverá perguntar se o usuário vai continuar. No final, mostre: qual é o total gasto na compra, quantos produtos custam mais de R$ 1000 e qual é o nome do produto mais barato.
